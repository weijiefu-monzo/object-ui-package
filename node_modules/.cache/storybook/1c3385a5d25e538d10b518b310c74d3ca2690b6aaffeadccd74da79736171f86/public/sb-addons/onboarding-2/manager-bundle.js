...
(() => {
  ...
  // node_modules/@storybook/addon-onboarding/dist/Onboarding-LKCUBABR.js
  var Onboarding_LKCUBABR_exports = {};
  __export(Onboarding_LKCUBABR_exports, {
    default: () => Onboarding
  });
  function y(y2, z2 = {}) {
  ...
  function Onboarding({ api }) {
    let [enabled, setEnabled] = useState(!0), [showConfetti, setShowConfetti] = useState(!1), [step, setStep] = useState("1:Intro"), [primaryControl, setPrimaryControl] = useState(), [saveFromControls, setSaveFromControls] = useState(), [createNewStoryForm, setCreateNewStoryForm] = useState(), [createdStory, setCreatedStory] = useState(), userAgent = globalThis?.navigator?.userAgent, selectStory = useCallback((storyId) => {
      ...
      api.emit(STORYBOOK_ADDON_ONBOARDING_CHANNEL, { step: "7:FinishedOnboarding", type: "telemetry", userAgent }), api.emit(STORYBOOK_ADDON_ONBOARDING_CHANNEL, { answers, type: "survey", userAgent }), selectStory("configure-your-project--docs"), disableOnboarding();
    ...
    }), [api]), useEffect(() => api.emit(STORYBOOK_ADDON_ONBOARDING_CHANNEL, { step, type: "telemetry", userAgent }), [api, step, userAgent]), !enabled) return null;
...
`, Tooltip = ({ index, size, step, closeProps, primaryProps, tooltipProps }) => (useEffect(() => {
  ...
  // node_modules/.cache/storybook/1c3385a5d25e538d10b518b310c74d3ca2690b6aaffeadccd74da79736171f86/sb-manager/onboarding-2/manager-bundle.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  ...
  // node_modules/@storybook/addon-onboarding/dist/manager.js
  var Onboarding2 = lazy(() => Promise.resolve().then(() => (init_Onboarding_LKCUBABR(), Onboarding_LKCUBABR_exports)));
