...
import {
  ...
  xr,
  yO
} from "./chunk-2HXHLLKL.js";
import {
  Xr,
  require_channels,
  require_client_logger
} from "./chunk-UIISBVAW.js";
import {
...
var dt = Jr((fe2, yt) => {
  (function(n2, s2) {
    ...
    r(m2, "getQuoted");
    let T3 = new RegExp("[$_\\p{ID_Start}]|\\\\u\\p{Hex_Digit}{4}|\\\\u\\{0*(?:\\p{Hex_Digit}{1,5}|10\\p{Hex_Digit}{4})\\}", "u"), g4 = new RegExp(
    ...
    function S2(e) {
      return (t2) => {
        if (!t2.startsWith(e))
          return null;
        let o2 = t2[e.length];
        return o2 !== void 0 && g4.test(o2) ? null : {
          type: e,
          text: e
        };
      };
    ...
    let we2 = r((e, t2, o2) => {
      ...
      return o2 == null && i2 === "?" && !Ye(l2) || o2 != null && i2 === "?" ? (e.consume("?"), o2 == null ? {
        ...
        element: e.parseType(y3.NULLABLE),
        meta: {
          position: "prefix"
        }
      } : {
    ...
    function x4(e) {
      let t2 = r((o2, i2, l2) => {
        let f2 = o2.lexer.current.type, d3 = o2.lexer.next.type;
        if (l2 === null) {
          if ("parsePrefix" in e && e.accept(f2, d3))
            return e.parsePrefix(o2);
        } else if ("parseInfix" in e && e.precedence > i2 && e.accept(f2, d3))
    ...
    let Q3 = x4({
      ...
      accept: r((e) => e === "=", "accept"),
      precedence: y3.OPTIONAL,
      parsePrefix: r((e) => (e.consume("="), {
        type: "JsdocTypeOptional",
        element: e.parseType(y3.OPTIONAL),
        meta: {
          position: "prefix"
        }
      }), "parsePrefix"),
      ...
      parsePrefix: r((e) => {
        ...
        let t2 = e.parseIntermediateType(y3.ALL);
        if (!e.consume(")"))
    ...
    function Bt({ allowTrailingComma: e }) {
      return x4({
        ...
        parseInfix: r((t2, o2) => {
          ...
          do
            try {
              let l2 = t2.parseIntermediateType(y3.PARAMETER_LIST);
              i2.push(he2(l2));
            } catch (l2) {
    ...
    let Ct = x4({
      ...
      precedence: y3.GENERIC,
      parseInfix: r((e, t2) => {
        let o2 = e.consume(".");
        e.consume("<");
        let i2 = [];
        do
          i2.push(e.parseType(y3.PARAMETER_LIST));
        while (e.consume(","));
        if (!e.consume(">"))
    ...
    function ee2({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: t2, pathGrammar: o2 }) {
      return r(function(l2, f2, d3) {
        if (d3 == null || f2 >= y3.NAME_PATH)
          return null;
        let h2 = l2.lexer.current.type, D2 = l2.lexer.next.type;
        if (!(h2 === "." && D2 !== "<" || h2 === "[" && (e || d3.type === "JsdocTypeName") || t2 && (h2 === "~" || h2 === "#")))
          return null;
        let O3, ae2 = false;
        l2.consume(".") ? O3 = "property" : l2.consume("[") ? (O3 = "property-brackets", ae2 = true) : l2.consume("~") ? O3 = "inner" : (l2.consume("#"), O3 = "instance");
        let rt = o2 !== null ? new I2(o2, l2.lexer, l2) : l2, k2 = rt.parseIntermediateType(y3.NAME_PATH);
    ...
    function te2({ pathGrammar: e, allowedTypes: t2 }) {
      return x4({
        ...
        parsePrefix: r((o2) => {
          ...
          let d3 = new I2(e, o2.lexer, o2), h2 = d3.parseInfixIntermediateType(l2, y3.ALL);
          return o2.acceptLexerState(d3), J3(h2);
        }, "parsePrefix")
      });
    }
      ...
      return x4({
        ...
        parsePrefix: r((l2) => {
          ...
          let h2 = {
            ...
            constructor: f2,
            parenthesis: d3
          }, D2 = l2.parseIntermediateType(y3.FUNCTION);
          if (e === void 0)
            h2.parameters = Kt(D2);
          else {
          ...
          if (l2.consume(":"))
            h2.returnType = l2.parseType(y3.PREFIX);
          else if (!t2)
    ...
    function Ee2({ allowPostfix: e, allowEnclosingBrackets: t2 }) {
      return x4({
        ...
        precedence: y3.PREFIX,
        parsePrefix: r((o2) => {
          o2.consume("...");
          let i2 = t2 && o2.consume("[");
          try {
            let l2 = o2.parseType(y3.PREFIX);
            if (i2 && !o2.consume("]"))
    ...
    let Ge2 = x4({
      ...
      parseInfix: r((e, t2) => {
        ...
        if (!e.consume(")")) {
          let i2 = e.parseIntermediateType(y3.SYMBOL);
        ...
        parsePrefix: r((o2) => {
          ...
          if (!o2.consume("}")) {
            ...
            for (; ; ) {
              ...
              let d3 = f2.parseIntermediateType(y3.OBJECT);
              o2.acceptLexerState(f2), d3 === void 0 && t2 && (d3 = o2.parseIntermediateType(y3.OBJECT));
              let h2 = false;
              if (d3.type === "JsdocTypeNullable" && (h2 = true, d3 = d3.element), d3.type === "JsdocTypeNumber" || d3.type === "JsdocTypeName" || d3.type === "JsdocTypeStringValue") {
                let E2;
                d3.type === "JsdocTypeStringValue" && (E2 = d3.meta.quote), i2.elements.push({
                  type: "JsdocTypeObjectField",
                  key: d3.value.toString(),
                  right: void 0,
                  optional: h2,
                  readonly: false,
                  meta: {
              ...
              } else if (d3.type === "JsdocTypeObjectField" || d3.type === "JsdocTypeJsdocObjectField")
                i2.elements.push(d3);
              else
                throw new c2(d3);
    ...
    function De2({ allowSquaredProperties: e, allowKeyTypes: t2, allowReadonly: o2, allowOptional: i2 }) {
      return x4({
        ...
        parseInfix: r((l2, f2) => {
          ...
          let E2 = (d3 = l2.baseParser) !== null && d3 !== void 0 ? d3 : l2;
          if (E2.acceptLexerState(l2), f2.type === "JsdocTypeNumber" || f2.type === "JsdocTypeName" || f2.type === "JsdocTypeStringValue" || Je(f2)) {
            if (Je(f2) && !e)
              throw new c2(f2);
            E2.consume(":");
            let O3;
            f2.type === "JsdocTypeStringValue" && (O3 = f2.meta.quote);
            let ae2 = E2.parseType(y3.KEY_VALUE);
            ...
            if (!t2)
              throw new c2(f2);
            E2.consume(":");
            let O3 = E2.parseType(y3.KEY_VALUE);
            return l2.acceptLexerState(E2), {
      ...
      return x4({
        ...
        parseInfix: r((o2, i2) => {
          ...
          if (e && i2.type === "JsdocTypeNullable" && (l2 = true, i2 = i2.element), t2 && i2.type === "JsdocTypeVariadic" && i2.element !== void 0 && (f2 = true, i2 = i2.element), i2.type !== "JsdocTypeName")
            throw new c2(i2);
          o2.consume(":");
          let d3 = o2.parseType(y3.KEY_VALUE);
          return {
    ...
    let ze2 = [
      ...
      parsePrefix: r((e) => (e.consume("typeof"), {
        ...
        element: J3(e.parseType(y3.KEY_OF_TYPE_OF))
      }), "parsePrefix")
    }), qt = [
      R2({
    ...
    function Gt({ allowQuestionMark: e }) {
      return x4({
        ...
        parsePrefix: r((t2) => {
          ...
          if (t2.consume("]"))
            return o2;
          let i2 = t2.parseIntermediateType(y3.ALL);
    ...
    let Xt = x4({
      ...
      parsePrefix: r((e) => (e.consume("readonly"), {
        ...
        element: e.parseType(y3.KEY_VALUE)
      }), "parsePrefix")
    }), Qt = x4({
      ...
      parseInfix: r((e, t2) => (e.consume("=>"), {
        ...
        constructor: false,
        parenthesis: true,
        returnType: e.parseType(y3.OBJECT)
      }), "parseInfix")
    }), Zt = x4({
      name: "intersectionParslet",
      accept: r((e) => e === "&", "accept"),
      precedence: y3.INTERSECTION,
      parseInfix: r((e, t2) => {
        e.consume("&");
        let o2 = [];
        do
          o2.push(e.parseType(y3.INTERSECTION));
        while (e.consume("&"));
        return {
      ...
      parsePrefix: r((e) => {
        ...
        if (e.consume(":")) {
          ...
          i2.acceptLexerState(e), o2 = {
            ...
            key: t2,
            right: i2.parseType(y3.INDEX_BRACKETS)
          ...
          i2.acceptLexerState(e), o2 = {
            ...
            key: t2,
            right: i2.parseType(y3.ARRAY_BRACKETS)
          }, e.acceptLexerState(i2);
        } else
    ...
    let ur = {
      ...
      JsdocTypeNamePath: r((e, t2) => {
        ...
        if (f2.owner.type === "MODULE") {
          let d3 = f2.owner;
          return f2.owner = f2.owner.value, d3.value = f2, d3;
        } else
          return f2;
      }, "JsdocTypeNamePath"),
...
var C = r((n2) => {
  ...
  switch (typeof a2 < "u" && (u2.raw = a2), s2) {
    case "enum": {
      let T3 = p2 ? c2 : c2.map((g4) => ie(g4.value));
      return { ...u2, name: s2, value: T3 };
    }
    case "string":
    case "number":
    case "symbol":
    ...
    case "shape":
    case "exact":
      let m2 = Re(c2, (T3) => C(T3));
      return { ...u2, name: "object", value: m2 };
    case "union":
      return { ...u2, name: "union", value: c2.map((T3) => C(T3)) };
    case "instanceOf":
    case "element":
    case "elementType":
    default: {
      if (s2?.indexOf("|") > 0)
        try {
          let P3 = s2.split("|").map((b2) => JSON.parse(b2));
          return { ...u2, name: "enum", value: P3 };
        } catch {
        }
      let T3 = c2 ? `${s2}(${c2})` : s2, g4 = vr.test(s2) ? "function" : "other";
      return { ...u2, name: g4, value: T3 };
    }
  }
}, "convert");
var Ar = r((n2) => {
...
function _e({ fence: n2 = "```" } = {}) {
  ...
  return r(function(c2) {
    let u2 = [[]], m2 = false;
    for (let T3 of c2)
      jr.test(T3.tokens.description) && !m2 ? u2.push([T3]) : u2[u2.length - 1].push(T3), m2 = a2(T3.tokens.description, m2);
    return u2;
  }, "parseBlock");
}
r(_e, "getParser");
...
function Ve({ startLine: n2 = 0, markers: s2 = v } = {}) {
  ...
  return r(function(u2) {
    let m2 = u2, T3 = Fe();
    if ([T3.lineEnd, m2] = lt(m2), [T3.start, m2] = A2(m2), a2 === null && m2.startsWith(s2.start) && !m2.startsWith(s2.nostart) && (a2 = [], T3.delimiter = m2.slice(0, s2.start.length), m2 = m2.slice(s2.start.length), [T3.postDelimiter, m2] = A2(m2)), a2 === null)
      return p2++, null;
    let g4 = m2.trimRight().endsWith(s2.end);
    if (T3.delimiter === "" && m2.startsWith(s2.delim) && !m2.startsWith(s2.end) && (T3.delimiter = s2.delim, m2 = m2.slice(s2.delim.length), [
      T3.postDelimiter,
      m2
    ] = A2(m2)), g4) {
      let P3 = m2.trimRight();
      T3.end = m2.slice(P3.length - s2.end.length), m2 = P3.slice(0, -s2.end.length);
    }
    if (T3.description = m2, a2.push({ number: p2, source: u2, tokens: T3 }), p2++, g4) {
      let P3 = a2.slice();
      return a2 = null, P3;
    }
    return null;
...
function le(n2 = "compact") {
  ...
  return (a2) => {
    let p2 = 0, c2 = [];
    for (let [T3, { tokens: g4 }] of a2.source.entries()) {
      let P3 = "";
      if (T3 === 0 && g4.description[0] !== "{")
        return a2;
      for (let b2 of g4.description)
        if (b2 === "{" && p2++, b2 === "}" && p2--, P3 += b2, p2 === 0)
          break;
      if (c2.push([g4, P3]), p2 === 0)
        break;
    }
    if (p2 !== 0)
    ...
    for (let [T3, [g4, P3]] of c2.entries())
      g4.type = P3, T3 > 0 && (g4.type = g4.postDelimiter.slice(m2) + P3, g4.postDelimiter = g4.postDelimiter.slice(0, m2)), [g4.postType, g4.description] = A2(g4.description.slice(P3.length)), u2.push(g4.type);
...
function ue() {
  ...
  return (s2) => {
    ...
    if (c2.length > 1 && c2[0] === "" && c2.length % 2 === 1)
      return s2.name = c2[1], a2.name = `"${c2[1]}"`, [a2.postName, a2.description] = A2(p2.slice(a2.name.length)), s2;
    let u2 = 0, m2 = "", T3 = false, g4;
    for (let b2 of p2) {
      if (u2 === 0 && je(b2))
        break;
      b2 === "[" && u2++, b2 === "]" && u2--, m2 += b2;
    ...
    if (m2[0] === "[" && m2[m2.length - 1] === "]") {
      T3 = true, m2 = m2.slice(1, -1);
      let b2 = m2.split("=");
      if (m2 = b2[0].trim(), b2[1] !== void 0 && (g4 = b2.slice(1).join("=").trim()), m2 === "")
        return s2.problems.push({
    ...
    return s2.optional = T3, s2.name = m2, a2.name = P3, g4 !== void 0 && (s2.default = g4), [a2.postName, a2.description] = A2(p2.slice(a2.name.length)), s2;
  };
}
r(ue, "nameTokenizer");
...
function Be({ startLine: n2 = 0, fence: s2 = "```", spacing: a2 = "compact", markers: p2 = v, tokenizers: c2 = [
  ...
  let u2 = Ve({ startLine: n2, markers: p2 }), m2 = _e({ fence: s2 }), T3 = Le({ tokenizers: c2 }), g4 = Ue(a2);
  return function(P3) {
    let b2 = [];
    for (let de2 of ut(P3)) {
      let q3 = u2(de2);
      if (q3 === null)
        continue;
      let S2 = m2(q3), z3 = S2.slice(1).map(T3);
      b2.push({
        description: g4(S2[0], p2),
        tags: z3,
        source: q3,
...
r(Qr, "extractReturns");
var _2 = (0, $.stringifyRules)();
var Zr = _2.JsdocTypeObject;
_2.JsdocTypeAny = () => "any";
_2.JsdocTypeObject = (n2, s2) => `(${Zr(n2, s2)})`;
_2.JsdocTypeOptional = (n2, s2) => s2(n2.element);
_2.JsdocTypeNullable = (n2, s2) => s2(n2.element);
_2.JsdocTypeNotNullable = (n2, s2) => s2(n2.element);
_2.JsdocTypeUnion = (n2, s2) => n2.elements.map(s2).join("|");
function ht(n2) {
  try {
...
var qe = r((...n2) => {
  let s2 = {}, a2 = n2.filter(Boolean), p2 = a2.reduce((c2, u2) => (Object.entries(u2).forEach(([m2, T3]) => {
    let g4 = c2[m2];
    Array.isArray(T3) || typeof g4 > "u" ? c2[m2] = T3 : X(T3) && X(g4) ? s2[m2] = true : typeof T3 < "u" && (c2[m2] = T3);
  }), c2), {});
...
function format() {
  ...
  return b2.forEach(function(d22) {
    a2 = a2.replace(/%[a-z]/, d22);
  }), a2;
}
...
var EmptyBlock = (props) => Rn.createElement(Wrapper, { ...props, className: "docblock-emptyblock sb-unstyled" });
...
var SourceSkeleton = () => Rn.createElement(SourceSkeletonWrapper, null, Rn.createElement(SourceSkeletonPlaceholder, null), Rn.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), Rn.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), Rn.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }));
var Source = ({ isLoading, error, language, code, dark, format: format3 = true, ...rest }) => {
  let { typography } = St();
  if (isLoading) return Rn.createElement(SourceSkeleton, null);
  if (error) return Rn.createElement(EmptyBlock, null, error);
  let syntaxHighlighter = Rn.createElement(StyledSyntaxHighlighter, { bordered: true, copyable: true, format: format3, language: language ?? "jsx", className: "docblock-source sb-unstyled", ...rest }, code);
  if (typeof dark > "u") return syntaxHighlighter;
  let overrideTheme = dark ? Me.dark : Me.light;
  return Rn.createElement(Tt, { theme: Ir({ ...overrideTheme, fontCode: typography.fonts.mono, fontBase: typography.fonts.base }) }, syntaxHighlighter);
};
...
var DocsPageWrapper = ({ children, toc }) => Rn.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, toc, Rn.createElement(DocsContent, { className: "sbdocs sbdocs-content" }, children));
...
var IFrame = class extends x {
  ...
  render() {
    ...
    return Rn.createElement("iframe", { id, title, src, ...allowFullScreen ? { allow: "fullscreen" } : {}, loading: "lazy", ...rest });
  }
};
var ZoomContext = Q({ scale: 1 });
...
var InlineStory = (props) => {
  let storyRef = A(), [showLoader, setShowLoader] = d(true), [error, setError] = d(), { story, height, autoplay, forceInitialArgs, renderStoryToElement } = props;
  return y(() => {
  ...
  }, [autoplay, renderStoryToElement, story]), error ? Rn.createElement("pre", null, Rn.createElement(g3, { error })) : Rn.createElement(Rn.Fragment, null, height ? Rn.createElement("style", null, `#${storyBlockIdFromId(props)} { min-height: ${height}; transform: translateZ(0); overflow: auto }`) : null, showLoader && Rn.createElement(StorySkeleton, null), Rn.createElement("div", { ref: storyRef, id: `${storyBlockIdFromId(props)}-inner`, "data-name": story.name }));
};
var IFrameStory = ({ story, height = "500px" }) => Rn.createElement("div", { style: { width: "100%", height } }, Rn.createElement(ZoomContext.Consumer, null, ({ scale }) => Rn.createElement(IFrame, { key: "iframe", id: `iframe--${story.id}`, title: story.name, src: vw(BASE_URL, story.id, { viewMode: "story" }), allowFullScreen: true, scale, style: { width: "100%", height: "100%", border: "0 none" } })));
var ErrorMessage = xr.strong(({ theme }) => ({ color: theme.color.orange }));
var Story = (props) => {
  let { inline, story } = props;
  return inline && !props.autoplay && story.usesMount ? Rn.createElement(ErrorMessage, null, "This story mounts inside of play. Set", " ", Rn.createElement("a", { href: "https://storybook.js.org/docs/api/doc-blocks/doc-block-story?ref=ui#autoplay" }, "autoplay"), " ", "to true to view this story.") : Rn.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story sb-unstyled", "data-story-block": "true" }, inline ? Rn.createElement(InlineStory, { ...props }) : Rn.createElement(IFrameStory, { ...props }));
};
var StorySkeleton = () => Rn.createElement(dw, null);
...
var Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => Rn.createElement(Bar, { ...rest }, Rn.createElement(Wrapper2, { key: "left" }, isLoading ? [1, 2, 3].map((key) => Rn.createElement(IconPlaceholder, { key })) : Rn.createElement(Rn.Fragment, null, Rn.createElement(xo, { key: "zoomin", onClick: (e2) => {
  e2.preventDefault(), zoom(0.8);
}, title: "Zoom in" }, Rn.createElement(ZoomIcon, null)), Rn.createElement(xo, { key: "zoomout", onClick: (e2) => {
  e2.preventDefault(), zoom(1.25);
}, title: "Zoom out" }, Rn.createElement(ZoomOutIcon, null)), Rn.createElement(xo, { key: "zoomreset", onClick: (e2) => {
  e2.preventDefault(), resetZoom();
}, title: "Reset zoom" }, Rn.createElement(ZoomResetIcon, null)))));
...
var getSource = (withSource, expanded, setExpanded) => {
  switch (true) {
    ...
    case expanded:
      return { source: Rn.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Hide code", className: "docblock-code-toggle docblock-code-toggle--expanded", onClick: () => setExpanded(false) } };
    default:
      return { source: Rn.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Show code", className: "docblock-code-toggle", onClick: () => setExpanded(true) } };
  }
};
function getStoryId(children) {
  if (O.count(children) === 1) {
    let elt = children;
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = d(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = d(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = d(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = q(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-4XQHNFZO.js");
  ...
  return Rn.createElement(PreviewContainer, { withSource, withToolbar, ...props, className: previewClasses.join(" ") }, withToolbar && Rn.createElement(PositionedToolbar, { isLoading, border: true, zoom: (z22) => setScale(scale * z22), resetZoom: () => setScale(1), storyId: getStoryId(children), baseUrl: "./iframe.html" }), Rn.createElement(ZoomContext.Provider, { value: { scale } }, Rn.createElement(Relative, { className: "docs-story", onCopyCapture: withSource && onCopyCapture }, Rn.createElement(ChildrenContainer, { isColumn: isColumn || !Array.isArray(children), columns, layout, inline }, Rn.createElement(l3.Element, { centered: layout === "centered", scale: inline ? scale : 1 }, Array.isArray(children) ? children.map((child, i2) => Rn.createElement("div", { key: i2 }, child)) : Rn.createElement("div", null, children))), Rn.createElement(Ya, { actionItems }))), withSource && expanded && source);
};
xr(Preview)(() => ({ ".docs-story": { paddingTop: 32, paddingBottom: 40 } }));
var TabbedArgsTable = ({ tabs, ...props }) => {
  let entries = Object.entries(tabs);
  return entries.length === 1 ? Rn.createElement(ArgsTable, { ...entries[0][1], ...props }) : Rn.createElement(ml, null, entries.map((entry, index) => {
    let [label, table] = entry, id = `prop_table_div_${label}`, Component4 = "div", argsTableProps = index === 0 ? props : { sort: props.sort };
    return Rn.createElement(Component4, { key: id, id, title: label }, ({ active }) => active ? Rn.createElement(ArgsTable, { key: `prop_table_${label}`, ...table, ...argsTableProps }) : null);
  }));
};
...
var Typeset = ({ fontFamily, fontSizes, fontWeight, sampleText, ...props }) => Rn.createElement(Wrapper3, { ...props, className: "docblock-typeset sb-unstyled" }, fontSizes.map((size) => Rn.createElement(TypeSpecimen, { key: size }, Rn.createElement(Label, null, size), Rn.createElement(Sample, { style: { fontFamily, fontSize: size, fontWeight, lineHeight: 1.2 } }, sampleText || "Was he a beast if music could move him so?"))));
...
function renderSwatch(color, index) {
  return Rn.createElement(Swatch, { key: `${color}-${index}`, title: color, background: color });
}
function renderSwatchLabel(color, index, colorDescription) {
  return Rn.createElement(SwatchLabel, { key: `${color}-${index}`, title: color }, Rn.createElement("div", null, color, colorDescription && Rn.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  if (Array.isArray(colors)) return Rn.createElement(SwatchSpecimen, null, Rn.createElement(SwatchColors, null, colors.map((color, index) => renderSwatch(color, index))), Rn.createElement(SwatchLabels, null, colors.map((color, index) => renderSwatchLabel(color, index))));
  ...
  return Rn.createElement(SwatchSpecimen, null, Rn.createElement(SwatchColors, null, swatchElements), Rn.createElement(SwatchLabels, null, labelElements));
}
var ColorItem = ({ title, subtitle, colors }) => Rn.createElement(Item, null, Rn.createElement(ItemDescription, null, Rn.createElement(ItemTitle, null, title), Rn.createElement(ItemSubtitle, null, subtitle)), Rn.createElement(Swatches, null, renderSwatchSpecimen(colors)));
var ColorPalette = ({ children, ...props }) => Rn.createElement(jl, null, Rn.createElement(List, { ...props, className: "docblock-colorpalette sb-unstyled" }, Rn.createElement(ListHeading, null, Rn.createElement(ListName, null, "Name"), Rn.createElement(ListSwatches, null, "Swatches")), children));
...
var IconItem = ({ name, children }) => Rn.createElement(Item2, null, Rn.createElement(ItemSpecimen, null, children), Rn.createElement(ItemLabel, null, name));
var IconGallery = ({ children, ...props }) => Rn.createElement(jl, null, Rn.createElement(List2, { ...props, className: "docblock-icongallery sb-unstyled" }, children));
...
function jump(target, options) {
  ...
  function easeInOutQuad(t2, b2, c2, d22) {
    return t2 /= d22 / 2, t2 < 1 ? c2 / 2 * t2 * t2 + b2 : (t2--, -c2 / 2 * (t2 * (t2 - 2) - 1) + b2);
  }
}
...
var Title2 = ({ headingId, title }) => typeof title == "string" || !title ? Rn.createElement(Heading, { as: "h2", id: headingId, className: title ? "" : "sb-sr-only" }, title || "Table of contents") : Rn.createElement("div", { id: headingId }, title);
var TableOfContents = ({ title, disable, headingSelector, contentsSelector, ignoreSelector, unsafeTocbotOptions, channel, className }) => {
  ...
  let headingId = g();
  return Rn.createElement(Aside, { className }, disable ? null : Rn.createElement(Nav, { "aria-labelledby": headingId }, Rn.createElement(Title2, { headingId, title }), Rn.createElement("div", { className: "toc-wrapper" })));
};
function t() {
...
var T2 = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi;
var B2 = /^<!--[\s\S]*?(?:-->)/;
...
`).match(l2), c2 = false;
    return { items: a2.map(function(e4, n3) {
      let i4 = o2.exec(e4)[0].length, l32 = new RegExp("^ {1," + i4 + "}", "gm"), s2 = e4.replace(l32, "").replace(o2, ""), d22 = n3 === a2.length - 1, u2 = s2.indexOf(`
...
function Ae(e2) {
  return V.test(e2) ? "right" : q2.test(e2) ? "center" : Q2.test(e2) ? "left" : null;
}
...
`, { inline: t2 }));
  ...
  function q22(e2, t2) {
    ...
    return n3 ? n3.reduce(function(t3, n4) {
      ...
      if (r22 !== -1) {
        ...
        if (s2 === "ref") return t3;
        let d22 = t3[s2] = (function(e3, t4, n5, r3) {
        ...
        typeof d22 == "string" && (O2.test(d22) || R.test(d22)) && (t3[s2] = Z2(d22.trim()));
      } else n4 !== "style" && (t3[l[n4] || n4] = true);
      return t3;
    }, {}) : null;
  }
  i2.overrides = i2.overrides || {}, i2.sanitizer = i2.sanitizer || He, i2.slugify = i2.slugify || Le2, i2.namedCodesToUnicode = i2.namedCodesToUnicode ? t({}, o, i2.namedCodesToUnicode) : o, i2.createElement = i2.createElement || _;
  let Q22 = [], V2 = {}, X22 = { [r2.blockQuote]: { match: De(p), order: 1, parse(e2, t2, n3) {
  ...
  } }, [r2.breakLine]: { match: Ue2(m), order: 1, parse: Ze, render: (e2, t2, n3) => u2("br", { key: n3.key }) }, [r2.breakThematic]: { match: De(g2), order: 1, parse: Ze, render: (e2, t2, n3) => u2("hr", { key: n3.key }) }, [r2.codeBlock]: { match: De(k), order: 0, parse: (e2) => ({ lang: void 0, text: ze(e2[0].replace(/^ {4}/gm, "")).replace(ne, "$1") }), render: (e2, n3, r22) => u2("pre", { key: r22.key }, u2("code", t({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text)) }, [r2.codeFenced]: { match: De(y2), order: 0, parse: (e2) => ({ attrs: q22("code", e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: r2.codeBlock }) }, [r2.codeInline]: { match: Ie2(x3), order: 3, parse: (e2) => ({ text: e2[2].replace(ne, "$1") }), render: (e2, t2, n3) => u2("code", { key: n3.key }, e2.text) }, [r2.footnote]: { match: De(C2), order: 0, parse: (e2) => (Q22.push({ footnote: e2[2], identifier: e2[1] }), {}), render: qe2 }, [r2.footnoteReference]: { match: Re2($2), order: 1, parse: (e2) => ({ target: `#${i2.slugify(e2[1], Le2)}`, text: e2[1] }), render: (e2, t2, n3) => u2("a", { key: n3.key, href: i2.sanitizer(e2.target, "a", "href") }, u2("sup", { key: n3.key }, e2.text)) }, [r2.gfmTask]: { match: Re2(E), order: 1, parse: (e2) => ({ completed: e2[1].toLowerCase() === "x" }), render: (e2, t2, n3) => u2("input", { checked: e2.completed, key: n3.key, readOnly: true, type: "checkbox" }) }, [r2.heading]: { match: De(i2.enforceAtxHeadings ? L : z2), order: 1, parse: (e2, t2, n3) => ({ children: _e2(t2, e2[2], n3), id: i2.slugify(e2[2], Le2), level: e2[1].length }), render: (e2, t2, n3) => u2(`h${e2.level}`, { id: e2.id, key: n3.key }, t2(e2.children, n3)) }, [r2.headingSetext]: { match: De(A3), order: 0, parse: (e2, t2, n3) => ({ children: _e2(t2, e2[1], n3), level: e2[2] === "=" ? 1 : 2, type: r2.heading }) }, [r2.htmlBlock]: { match: Ue2(O2), order: 1, parse(e2, t2, n3) {
    let [, r22] = e2[3].match(le2), i3 = new RegExp(`^${r22}`, "gm"), l2 = e2[3].replace(i3, ""), o2 = (c2 = l2, Ee.some((e3) => e3.test(c2)) ? We : _e2);
    var c2;
    let s2 = e2[1].toLowerCase(), d22 = a.indexOf(s2) !== -1, u3 = (d22 ? s2 : e2[1]).trim(), p2 = { attrs: q22(u3, e2[2]), noInnerParse: d22, tag: u3 };
    return n3.inAnchor = n3.inAnchor || s2 === "a", d22 ? p2.text = e2[3] : p2.children = o2(t2, l2, n3), n3.inAnchor = false, p2;
    ...
    let t2 = e2[1].trim();
    return { attrs: q22(t2, e2[2] || ""), tag: t2 };
  ...
  let oe2 = (function(e2) {
    ...
    function n3(r22, i3) {
      ...
      for (i3.prevCapture = i3.prevCapture || ""; r22; ) {
        let d22 = 0;
        for (; d22 < t2.length; ) {
          if (c2 = t2[d22], l2 = e2[c2], i3.inline && !l2.match.inline) {
            d22++;
            continue;
          }
...
`).replace(S, "").replace(G, "    ");
  ...
  var ce22;
  let se2 = Z2(n2);
  return Q22.length ? u2("div", null, se2, u2("footer", { key: "footer" }, Q22.map(function(e2) {
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus, argType }) => {
  let onSetFalse = q(() => onChange(false), [onChange]), readonly = !!argType?.table?.readonly;
  if (value2 === void 0) return Rn.createElement(Ir2, { variant: "outline", size: "medium", id: getControlSetterButtonId(name), onClick: onSetFalse, disabled: readonly }, "Set boolean");
  let controlId = getControlId(name), parsedValue = typeof value2 == "string" ? parse(value2) : value2;
  return Rn.createElement(Label2, { "aria-disabled": readonly, htmlFor: controlId, "aria-label": name }, Rn.createElement("input", { id: controlId, type: "checkbox", onChange: (e2) => onChange(e2.target.checked), checked: parsedValue, role: "switch", disabled: readonly, name, onBlur, onFocus }), Rn.createElement("span", { "aria-hidden": "true" }, "False"), Rn.createElement("span", { "aria-hidden": "true" }, "True"));
};
...
var DateControl = ({ name, value: value2, onChange, onFocus, onBlur, argType }) => {
  let [valid, setValid] = d(true), dateRef = A(), timeRef = A(), readonly = !!argType?.table?.readonly;
  y(() => {
  ...
  return Rn.createElement(FlexSpaced, null, Rn.createElement(FormInput, { type: "date", max: "9999-12-31", ref: dateRef, id: `${controlId}-date`, name: `${controlId}-date`, readOnly: readonly, onChange: onDateChange, onFocus, onBlur }), Rn.createElement(FormInput, { type: "time", id: `${controlId}-time`, name: `${controlId}-time`, ref: timeRef, onChange: onTimeChange, readOnly: readonly, onFocus, onBlur }), valid ? null : Rn.createElement("div", null, "invalid"));
};
...
var NumberControl = ({ name, value: value2, onChange, min, max, step, onBlur, onFocus, argType }) => {
  let [inputValue, setInputValue] = d(typeof value2 == "number" ? value2 : ""), [forceVisible, setForceVisible] = d(false), [parseError, setParseError] = d(null), readonly = !!argType?.table?.readonly, handleChange = q((event) => {
  ...
  }, [onChange, setParseError]), onForceVisible = q(() => {
    setInputValue("0"), onChange(0), setForceVisible(true);
  }, [setForceVisible]), htmlElRef = A(null);
  return y(() => {
  ...
  }, [value2]), value2 === void 0 ? Rn.createElement(Ir2, { variant: "outline", size: "medium", id: getControlSetterButtonId(name), onClick: onForceVisible, disabled: readonly }, "Set number") : Rn.createElement(Wrapper4, null, Rn.createElement(FormInput2, { ref: htmlElRef, id: getControlId(name), type: "number", onChange: handleChange, size: "flex", placeholder: "Edit number...", value: inputValue, valid: parseError ? "error" : void 0, autoFocus: forceVisible, readOnly: readonly, name, min, max, step, onFocus, onBlur }));
};
...
var CheckboxControl = ({ name, options, value: value2, onChange, isInline, argType }) => {
  if (!options) return import_client_logger.logger.warn(`Checkbox with no options: ${name}`), Rn.createElement(Rn.Fragment, null, "-");
  let initial = selectedKeys(value2 || [], options), [selected, setSelected] = d(initial), readonly = !!argType?.table?.readonly, handleChange = (e2) => {
  ...
  return Rn.createElement(Wrapper5, { "aria-readonly": readonly, isInline }, Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return Rn.createElement(Label3, { key: id, htmlFor: id }, Rn.createElement("input", { type: "checkbox", disabled: readonly, id, name: id, value: key, onChange: handleChange, checked: selected?.includes(key) }), Rn.createElement(Text, null, key));
  }));
};
...
var RadioControl = ({ name, options, value: value2, onChange, isInline, argType }) => {
  if (!options) return import_client_logger.logger.warn(`Radio with no options: ${name}`), Rn.createElement(Rn.Fragment, null, "-");
  let selection = selectedKey(value2, options), controlId = getControlId(name), readonly = !!argType?.table?.readonly;
  return Rn.createElement(Wrapper6, { "aria-readonly": readonly, isInline }, Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return Rn.createElement(Label4, { key: id, htmlFor: id }, Rn.createElement("input", { type: "radio", id, name: controlId, disabled: readonly, value: key, onChange: (e2) => onChange(options[e2.currentTarget.value]), checked: key === selection }), Rn.createElement(Text2, null, key));
  }));
};
...
var SingleSelect = ({ name, value: value2, options, onChange, argType }) => {
  ...
  return Rn.createElement(SelectWrapper, null, Rn.createElement(ChevronSmallDownIcon, null), Rn.createElement(OptionsSelect, { disabled: readonly, id: controlId, value: selection, onChange: handleChange }, Rn.createElement("option", { key: "no-selection", disabled: true }, NO_SELECTION), Object.keys(options).map((key) => Rn.createElement("option", { key, value: key }, key))));
};
var MultiSelect = ({ name, value: value2, options, onChange, argType }) => {
  ...
  return Rn.createElement(SelectWrapper, null, Rn.createElement(OptionsSelect, { disabled: readonly, id: controlId, multiple: true, value: selection, onChange: handleChange }, Object.keys(options).map((key) => Rn.createElement("option", { key, value: key }, key))));
};
var SelectControl = (props) => {
  let { name, options } = props;
  return options ? props.isMulti ? Rn.createElement(MultiSelect, { ...props }) : Rn.createElement(SingleSelect, { ...props }) : (import_client_logger.logger.warn(`Select with no options: ${name}`), Rn.createElement(Rn.Fragment, null, "-"));
};
...
var OptionsControl = (props) => {
  ...
  if (Control) return Rn.createElement(Control, { ...normalized });
...
function JsonNodeAccordion({ children, name, collapsed, keyPath, deep, ...props }) {
  ...
  return Rn.createElement(Container, { as: containerTag }, Rn.createElement(Trigger, { type: "button", "aria-expanded": !collapsed, id: ids.trigger, "aria-controls": ids.region, className: "rejt-accordion-button", ...props }, name, " :"), Rn.createElement(Region, { role: "region", id: ids.region, "aria-labelledby": ids.trigger, className: "rejt-accordion-region" }, children));
}
var ERROR = "Error";
var OBJECT = "Object";
var ARRAY = "Array";
...
var JsonAddValue = class extends x {
  constructor(props) {
  ...
  render() {
    let { handleCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep } = this.props, addButtonElementLayout = addButtonElement && _n(addButtonElement, { onClick: this.onSubmit }), cancelButtonElementLayout = cancelButtonElement && _n(cancelButtonElement, { onClick: handleCancel }), inputElementValue = inputElementGenerator(VALUE, keyPath, deep), inputElementValueLayout = _n(inputElementValue, { placeholder: "Value", ref: this.refInputValue, onKeyDown: this.onKeydown }), inputElementKeyLayout = null;
    if (!onlyValue) {
      let inputElementKey = inputElementGenerator(KEY, keyPath, deep);
      inputElementKeyLayout = _n(inputElementKey, { placeholder: "Key", ref: this.refInputKey, onKeyDown: this.onKeydown });
    }
    return Rn.createElement("span", { className: "rejt-add-value-node" }, inputElementKeyLayout, inputElementValueLayout, addButtonElementLayout, cancelButtonElementLayout);
  }
};
JsonAddValue.defaultProps = { onlyValue: false, addButtonElement: Rn.createElement("button", null, "+"), cancelButtonElement: Rn.createElement("button", null, "c") };
var JsonArray = class extends x {
  constructor(props) {
    super(props);
...
var JsonFunctionValue = class extends x {
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      let textareaElement = textareaElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), textareaElementLayout = _n(textareaElement, { ref: this.refInput, defaultValue: value2, onKeyDown: this.onKeydown });
      result = Rn.createElement("span", { className: "rejt-edit-form", style: style.editForm }, textareaElementLayout), minusElement = null;
    } else {
      result = Rn.createElement("span", { className: "rejt-value", style: style.value, onClick: resultOnlyResult ? void 0 : this.handleEditMode }, value2);
      let parentPropertyName = comeFromKeyPath.at(-1), minusMenuLayout = minusMenuElement && _n(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus, "aria-label": `remove the function '${String(name)}'${String(parentPropertyName) ? ` from '${String(parentPropertyName)}'` : ""}` });
      minusElement = resultOnlyResult ? null : minusMenuLayout;
    }
    return Rn.createElement("li", { className: "rejt-value-node", style: style.li }, Rn.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " "), result, minusElement);
  }
};
JsonFunctionValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => {
}, cancelButtonElement: Rn.createElement("button", null, "c"), minusMenuElement: Rn.createElement("span", null, " - ") };
var JsonNode = class extends x {
  constructor(props) {
  ...
  render() {
    ...
    switch (dataType) {
      case ERROR:
        return Rn.createElement(JsonObject, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly: readOnlyTrue, dataType, getStyle, addButtonElement, cancelButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case OBJECT:
        return Rn.createElement(JsonObject, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly, dataType, getStyle, addButtonElement, cancelButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case ARRAY:
        return Rn.createElement(JsonArray, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly, dataType, getStyle, addButtonElement, cancelButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case STRING:
        return Rn.createElement(JsonValue, { name, value: `"${data}"`, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NUMBER:
        return Rn.createElement(JsonValue, { name, value: data, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case BOOLEAN:
        return Rn.createElement(JsonValue, { name, value: data ? "true" : "false", originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case DATE:
        return Rn.createElement(JsonValue, { name, value: data.toISOString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NULL:
        return Rn.createElement(JsonValue, { name, value: "null", originalValue: "null", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case UNDEFINED:
        return Rn.createElement(JsonValue, { name, value: "undefined", originalValue: "undefined", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case FUNCTION:
        return Rn.createElement(JsonFunctionValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, textareaElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case SYMBOL:
        return Rn.createElement(JsonValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      default:
        return null;
    }
  }
...
var JsonObject = class extends x {
  constructor(props) {
    super(props);
  ...
  renderCollapsed() {
    ...
    return Rn.createElement(Rn.Fragment, null, Rn.createElement("span", { style: collapsed }, "{...}", " ", keyList.length, " ", keyList.length === 1 ? "key" : "keys"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, nextDeep, addFormVisible } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, addForm, ul, delimiter } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = plusMenuElement && _n(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus, "aria-label": `add a new property to the object '${String(name)}'` }), removeItemButton = minusMenuElement && _n(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus, "aria-label": `remove the object '${String(name)}'` }), list = keyList.map((key) => Rn.createElement(JsonNode, { key, name: key, data: data[key], keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveValue(key), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser }));
    return Rn.createElement(Rn.Fragment, null, Rn.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, "{"), !isReadOnly && addItemButton, Rn.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, list), !isReadOnly && addFormVisible && Rn.createElement("div", { className: "rejt-add-form", style: addForm }, Rn.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), Rn.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, "}"), !isReadOnly && removeItemButton);
  }
  render() {
...
JsonObject.defaultProps = { keyPath: [], deep: 0, minusMenuElement: Rn.createElement("span", null, " - "), plusMenuElement: Rn.createElement("span", null, " + ") };
var JsonValue = class extends x {
  constructor(props) {
    super(props);
    let keyPath = [...props.keyPath || [], props.name];
    this.state = { value: props.value, name: props.name, keyPath: keyPath ?? [], deep: props.deep ?? 0, editEnabled: false, inputRef: null }, this.handleEditMode = this.handleEditMode.bind(this), this.refInput = this.refInput.bind(this), this.handleCancelEdit = this.handleCancelEdit.bind(this), this.handleEdit = this.handleEdit.bind(this), this.onKeydown = this.onKeydown.bind(this);
  ...
  render() {
    let { name, value: value2, editEnabled, keyPath, deep } = this.state, { handleRemove, originalValue, readOnly, dataType, getStyle, inputElementGenerator, minusMenuElement, keyPath: comeFromKeyPath } = this.props, style = getStyle(name, originalValue, keyPath, deep, dataType), isReadOnly = readOnly(name, originalValue, keyPath, deep, dataType), isEditing = editEnabled && !isReadOnly, inputElement = inputElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), inputElementLayout = _n(inputElement, { ref: this.refInput, defaultValue: JSON.stringify(originalValue), onKeyDown: this.onKeydown }), parentPropertyName = keyPath.at(-2), minusMenuLayout = minusMenuElement && _n(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: style.minus, "aria-label": `remove the property '${String(name)}' with value '${String(originalValue)}'${String(parentPropertyName) ? ` from '${String(parentPropertyName)}'` : ""}` });
    return Rn.createElement("li", { className: "rejt-value-node", style: style.li }, Rn.createElement("span", { className: "rejt-name", style: style.name }, name, " : "), isEditing ? Rn.createElement("span", { className: "rejt-edit-form", style: style.editForm }, inputElementLayout) : Rn.createElement("span", { className: "rejt-value", style: style.value, onClick: isReadOnly ? void 0 : this.handleEditMode }, String(value2)), !isReadOnly && !isEditing && minusMenuLayout);
  }
};
JsonValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => Promise.resolve(), cancelButtonElement: Rn.createElement("button", null, "c"), minusMenuElement: Rn.createElement("span", null, " - ") };
...
var JsonTree = class extends x {
  ...
  render() {
    ...
    return textareaElement && getObjectType(textareaElement) !== "Function" && (textareaElementFunction = () => textareaElement), dataType === "Object" || dataType === "Array" ? Rn.createElement("div", { className: "rejt-tree" }, Rn.createElement(JsonNode, { data, name: rootName || "root", deep: -1, isCollapsed: isCollapsed ?? (() => false), onUpdate: this.onUpdate, onDeltaUpdate: onDeltaUpdate ?? (() => {
...
} }, onSubmitValueParser: (isEditMode, keyPath, deep, name, rawValue) => parse3(rawValue), inputElement: () => Rn.createElement("input", null), textareaElement: () => Rn.createElement("textarea", null), fallback: null };
...
var ObjectControl = ({ name, value: value2, onChange, argType }) => {
  let theme = St(), data = T(() => value2 && cloneDeep(value2), [value2]), hasData = data != null, [showRaw, setShowRaw] = d(!hasData), [parseError, setParseError] = d(null), readonly = !!argType?.table?.readonly, updateRaw = q((raw) => {
    try {
      raw && onChange(JSON.parse(raw)), setParseError(null);
    } catch (e2) {
      setParseError(e2);
    }
  }, [onChange]), [forceVisible, setForceVisible] = d(false), onForceVisible = q(() => {
    onChange({}), setForceVisible(true);
  }, [setForceVisible]), htmlElRef = A(null);
  if (y(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), !hasData) return Rn.createElement(Ir2, { disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
  let rawJSONForm = Rn.createElement(RawInput, { ref: htmlElRef, id: getControlId(name), name, defaultValue: value2 === null ? "" : JSON.stringify(value2, null, 2), onBlur: (event) => updateRaw(event.target.value), placeholder: "Edit JSON string...", autoFocus: forceVisible, valid: parseError ? "error" : void 0, readOnly: readonly }), isObjectOrArray = Array.isArray(value2) || typeof value2 == "object" && value2?.constructor === Object;
  return Rn.createElement(Wrapper7, { "aria-readonly": readonly }, isObjectOrArray && Rn.createElement(RawButton, { role: "switch", "aria-checked": showRaw, "aria-label": `Edit the ${name} properties in text format`, onClick: (e2) => {
    e2.preventDefault(), setShowRaw((isRaw) => !isRaw);
  } }, showRaw ? Rn.createElement(EyeCloseIcon, null) : Rn.createElement(EyeIcon, null), Rn.createElement("span", null, "RAW")), showRaw ? rawJSONForm : Rn.createElement(JsonTree, { readOnly: readonly || !isObjectOrArray, isCollapsed: isObjectOrArray ? void 0 : () => true, data, rootName: name, onFullyUpdate: onChange, getStyle: getCustomStyleFunction(theme), cancelButtonElement: Rn.createElement(ButtonInline, { type: "button" }, "Cancel"), addButtonElement: Rn.createElement(ButtonInline, { type: "submit", primary: true }, "Save"), plusMenuElement: Rn.createElement(ActionButton, { type: "button" }, Rn.createElement(AddIcon, null)), minusMenuElement: Rn.createElement(ActionButton, { type: "button" }, Rn.createElement(SubtractIcon, null)), inputElement: (_22, __, ___, key) => key ? Rn.createElement(Input, { onFocus: selectValue, onBlur: dispatchEnterKey }) : Rn.createElement(Input, null), fallback: rawJSONForm }));
};
...
var RangeControl = ({ name, value: value2, onChange, min = 0, max = 100, step = 1, onBlur, onFocus, argType }) => {
  ...
  }, hasValue = value2 !== void 0, numberOFDecimalsPlaces = T(() => getNumberOfDecimalPlaces(step), [step]), readonly = !!argType?.table?.readonly;
  return Rn.createElement(RangeWrapper, { "aria-readonly": readonly }, Rn.createElement(RangeLabel, null, min), Rn.createElement(RangeInput, { id: getControlId(name), type: "range", disabled: readonly, onChange: handleChange, name, min, max, step, onFocus, onBlur, value: value2 ?? min }), Rn.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max }, hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--", " / ", max));
};
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength, argType }) => {
  ...
  }, readonly = !!argType?.table?.readonly, [forceVisible, setForceVisible] = d(false), onForceVisible = q(() => {
    onChange(""), setForceVisible(true);
  }, [setForceVisible]);
  if (value2 === void 0) return Rn.createElement(Ir2, { variant: "outline", size: "medium", disabled: readonly, id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
  let isValid = typeof value2 == "string";
  return Rn.createElement(Wrapper8, null, Rn.createElement(Z3.Textarea, { id: getControlId(name), maxLength, onChange: handleChange, disabled: readonly, size: "flex", placeholder: "Edit string...", autoFocus: forceVisible, valid: isValid ? void 0 : "error", name, value: isValid ? value2 : "", onFocus, onBlur }), maxLength && Rn.createElement(MaxLength, { isMaxed: value2?.length === maxLength }, value2?.length ?? 0, " / ", maxLength));
};
...
var FilesControl = ({ onChange, name, accept = "image/*", value: value2, argType }) => {
  let inputElement = A(null), readonly = argType?.control?.readOnly;
  ...
  }, [value2, name]), Rn.createElement(FileInput, { ref: inputElement, id: getControlId(name), type: "file", name, multiple: true, disabled: readonly, onChange: handleFileChange, accept, size: "flex" });
};
var LazyColorControl = z(() => import("./Color-AVL7NMMY-UN6AZCDM.js"));
var ColorControl = (props) => Rn.createElement(P, { fallback: Rn.createElement("div", null) }, Rn.createElement(LazyColorControl, { ...props }));
...
var NoControl = () => Rn.createElement(Rn.Fragment, null, "-");
var ArgControl = ({ row, arg, updateArgs, isHovered }) => {
  let { key, control } = row, [isFocused, setFocused] = d(false), [boxedValue, setBoxedValue] = d({ value: arg });
  y(() => {
    isFocused || setBoxedValue({ value: arg });
  }, [isFocused, arg]);
  let onChange = q((argVal) => (setBoxedValue({ value: argVal }), updateArgs({ [key]: argVal }), argVal), [updateArgs, key]), onBlur = q(() => setFocused(false), []), onFocus = q(() => setFocused(true), []);
  if (!control || control.disable) {
    let canBeSetup = control?.disable !== true && row?.type?.name !== "function";
    return isHovered && canBeSetup ? Rn.createElement(Ai, { href: "https://storybook.js.org/docs/essentials/controls?ref=ui", target: "_blank", withArrow: true }, "Setup controls") : Rn.createElement(NoControl, null);
  }
  let props = { name: key, argType: row, value: boxedValue.value, onChange, onBlur, onFocus }, Control = Controls2[control.type] || NoControl;
  return Rn.createElement(Control, { ...props, ...control, controlType: control.type });
};
...
var ArgJsDoc = ({ tags }) => {
  ...
  return !hasDisplayableParams && !hasDisplayableReturns && !hasDisplayableDeprecated ? null : Rn.createElement(Rn.Fragment, null, Rn.createElement(Table, null, Rn.createElement("tbody", null, hasDisplayableDeprecated && Rn.createElement("tr", { key: "deprecated" }, Rn.createElement("td", { colSpan: 2 }, Rn.createElement("strong", null, "Deprecated"), ": ", tags.deprecated?.toString())), hasDisplayableParams && params.map((x22) => Rn.createElement("tr", { key: x22.name }, Rn.createElement("td", null, Rn.createElement("code", null, x22.name)), Rn.createElement("td", null, x22.description))), hasDisplayableReturns && Rn.createElement("tr", { key: "returns" }, Rn.createElement("td", null, Rn.createElement("code", null, "Returns")), Rn.createElement("td", null, tags.returns?.description)))));
};
...
var EmptyArg = () => Rn.createElement("span", null, "-");
var ArgText = ({ text, simple }) => Rn.createElement(Text3, { simple }, text);
...
var renderSummaryItems = (summaryItems, isExpanded = true) => {
  ...
  return isExpanded || (items = summaryItems.slice(0, ITEMS_BEFORE_EXPANSION)), items.map((item) => Rn.createElement(ArgText, { key: item, text: item === "" ? '""' : item }));
};
var ArgSummary = ({ value: value2, initialExpandedArgs }) => {
  let { summary, detail } = value2, [isOpen, setIsOpen] = d(false), [isExpanded, setIsExpanded] = d(initialExpandedArgs || false);
  if (summary == null) return null;
  let summaryAsString = typeof summary.toString == "function" ? summary.toString() : summary;
  if (detail == null) {
    if (/[(){}[\]<>]/.test(summaryAsString)) return Rn.createElement(ArgText, { text: summaryAsString });
    let summaryItems = getSummaryItems(summaryAsString), itemsCount = summaryItems.length;
    return itemsCount > ITEMS_BEFORE_EXPANSION ? Rn.createElement(Summary, { isExpanded }, renderSummaryItems(summaryItems, isExpanded), Rn.createElement(ExpandButton, { onClick: () => setIsExpanded(!isExpanded) }, isExpanded ? "Show less..." : `Show ${itemsCount - ITEMS_BEFORE_EXPANSION} more...`)) : Rn.createElement(Summary, null, renderSummaryItems(summaryItems));
  }
  return Rn.createElement(Z7, { closeOnOutsideClick: true, placement: "bottom", visible: isOpen, onVisibleChange: (isVisible) => {
    setIsOpen(isVisible);
  }, tooltip: Rn.createElement(Detail, { width: calculateDetailWidth(detail) }, Rn.createElement(ru, { language: "jsx", format: false }, detail)) }, Rn.createElement(Expandable, { className: "sbdocs-expandable" }, Rn.createElement("span", null, summaryAsString), isOpen ? Rn.createElement(ChevronUpIcon, null) : Rn.createElement(ChevronDownIcon2, null)));
};
var ArgValue = ({ value: value2, initialExpandedArgs }) => value2 == null ? Rn.createElement(EmptyArg, null) : Rn.createElement(ArgSummary, { value: value2, initialExpandedArgs });
...
var ArgRow = (props) => {
  let [isHovered, setIsHovered] = d(false), { row, updateArgs, compact, expandable, initialExpandedArgs } = props, { name, description } = row, table = row.table || {}, type = table.type || toSummary(row.type), defaultValue = table.defaultValue || row.defaultValue, required = row.type?.required, hasDescription = description != null && description !== "";
  return Rn.createElement("tr", { onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false) }, Rn.createElement(StyledTd, { expandable: expandable ?? false }, Rn.createElement(Name, null, name), required ? Rn.createElement(Required, { title: "Required" }, "*") : null), compact ? null : Rn.createElement("td", null, hasDescription && Rn.createElement(Description, null, Rn.createElement(index_modern_default, null, description)), table.jsDocTags != null ? Rn.createElement(Rn.Fragment, null, Rn.createElement(TypeWithJsDoc, { hasDescription }, Rn.createElement(ArgValue, { value: type, initialExpandedArgs })), Rn.createElement(ArgJsDoc, { tags: table.jsDocTags })) : Rn.createElement(Type, { hasDescription }, Rn.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact ? null : Rn.createElement("td", null, Rn.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? Rn.createElement("td", null, Rn.createElement(ArgControl, { ...props, isHovered })) : null);
};
...
var Empty = ({ inAddonPanel }) => {
  let [isLoading, setIsLoading] = d(true);
  return y(() => {
    let load = setTimeout(() => {
      setIsLoading(false);
    }, 100);
    return () => clearTimeout(load);
  }, []), isLoading ? null : Rn.createElement(Wrapper9, { inAddonPanel }, Rn.createElement(qo, { title: inAddonPanel ? "Interactive story playground" : "Args table with interactive controls couldn't be auto-generated", description: Rn.createElement(Rn.Fragment, null, "Controls give you an easy to use interface to test your components. Set your story args and you'll see controls appearing here automatically."), footer: Rn.createElement(Links, null, inAddonPanel && Rn.createElement(Rn.Fragment, null, Rn.createElement(Ai, { href: "https://storybook.js.org/docs/essentials/controls?ref=ui", target: "_blank", withArrow: true }, Rn.createElement(DocumentIcon, null), " Read docs")), !inAddonPanel && Rn.createElement(Ai, { href: "https://storybook.js.org/docs/essentials/controls?ref=ui", target: "_blank", withArrow: true }, Rn.createElement(DocumentIcon, null), " Learn how to set that up")) }));
};
...
var SectionRow = ({ level = "section", label, children, initialExpanded = true, colSpan = 3 }) => {
  let [expanded, setExpanded] = d(initialExpanded), Level = level === "subsection" ? Subsection : Section, itemCount = children?.length || 0, caption = level === "subsection" ? `${itemCount} item${itemCount !== 1 ? "s" : ""}` : "", helperText = `${expanded ? "Hide" : "Show"} ${level === "subsection" ? itemCount : label} item${itemCount !== 1 ? "s" : ""}`;
  return Rn.createElement(Rn.Fragment, null, Rn.createElement(StyledTr, { title: helperText }, Rn.createElement(Level, { colSpan: 1 }, Rn.createElement(ClickIntercept, { onClick: (e2) => setExpanded(!expanded), tabIndex: 0 }, helperText), Rn.createElement(FlexWrapper, null, expanded ? Rn.createElement(ExpanderIconDown, null) : Rn.createElement(ExpanderIconRight, null), label)), Rn.createElement(StyledTd2, { colSpan: colSpan - 1 }, Rn.createElement(ClickIntercept, { onClick: (e2) => setExpanded(!expanded), tabIndex: -1, style: { outline: "none" } }, helperText), expanded ? null : caption)), expanded ? children : null);
};
...
var Skeleton = () => Rn.createElement(TableWrapper, null, Rn.createElement(Row, null, Rn.createElement(Column, { position: "first" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "second" }, Rn.createElement(SkeletonText, { width: "30%" })), Rn.createElement(Column, { position: "third" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "last" }, Rn.createElement(SkeletonText, { width: "60%" }))), Rn.createElement(Row, null, Rn.createElement(Column, { position: "first" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "second" }, Rn.createElement(SkeletonText, { width: "80%" }), Rn.createElement(SkeletonText, { width: "30%" })), Rn.createElement(Column, { position: "third" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "last" }, Rn.createElement(SkeletonText, { width: "60%" }))), Rn.createElement(Row, null, Rn.createElement(Column, { position: "first" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "second" }, Rn.createElement(SkeletonText, { width: "80%" }), Rn.createElement(SkeletonText, { width: "30%" })), Rn.createElement(Column, { position: "third" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "last" }, Rn.createElement(SkeletonText, { width: "60%" }))), Rn.createElement(Row, null, Rn.createElement(Column, { position: "first" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "second" }, Rn.createElement(SkeletonText, { width: "80%" }), Rn.createElement(SkeletonText, { width: "30%" })), Rn.createElement(Column, { position: "third" }, Rn.createElement(SkeletonText, { width: "60%" })), Rn.createElement(Column, { position: "last" }, Rn.createElement(SkeletonText, { width: "60%" }))));
...
var ArgsTable = (props) => {
  ...
  if ("error" in props) {
    let { error } = props;
    return Rn.createElement(EmptyBlock, null, error, " ", Rn.createElement(Ai, { href: "http://storybook.js.org/docs/?ref=ui", target: "_blank", withArrow: true }, Rn.createElement(DocumentIcon, null), " Read the docs"));
  }
  if (isLoading) return Rn.createElement(Skeleton, null);
  ...
  if (hasNoUngrouped && hasNoSections && hasNoUngroupedSubsections) return Rn.createElement(Empty, { inAddonPanel });
  let colSpan = 1;
  ...
  return Rn.createElement(jl, null, Rn.createElement(TablePositionWrapper, null, updateArgs && !isLoading && resetArgs && Rn.createElement(ButtonPositionWrapper, null, Rn.createElement(xo, { onClick: () => resetArgs(), "aria-label": "Reset controls", title: "Reset controls" }, Rn.createElement(UndoIcon, null))), Rn.createElement(TableWrapper2, { compact, inAddonPanel, className: "docblock-argstable sb-unstyled" }, Rn.createElement("thead", { className: "docblock-argstable-head" }, Rn.createElement("tr", null, Rn.createElement("th", null, Rn.createElement("span", null, "Name")), compact ? null : Rn.createElement("th", null, Rn.createElement("span", null, "Description")), compact ? null : Rn.createElement("th", null, Rn.createElement("span", null, "Default")), updateArgs ? Rn.createElement("th", null, Rn.createElement("span", null, "Control")) : null)), Rn.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => Rn.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(groups.ungroupedSubsections).map(([subcategory, subsection]) => Rn.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => Rn.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common })))), Object.entries(groups.sections).map(([category, section]) => Rn.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map((row) => Rn.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(section.subsections).map(([subcategory, subsection]) => Rn.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => Rn.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common }))))))))));
};
var anchorBlockIdFromId = (storyId) => `anchor--${storyId}`;
var Anchor = ({ storyId, children }) => Rn.createElement("div", { id: anchorBlockIdFromId(storyId), className: "sb-anchor" }, children);
globalThis && globalThis.__DOCS_CONTEXT__ === void 0 && (globalThis.__DOCS_CONTEXT__ = Q(null), globalThis.__DOCS_CONTEXT__.displayName = "DocsContext");
var DocsContext = globalThis ? globalThis.__DOCS_CONTEXT__ : Q(null);
var useOf = (moduleExportOrType, validTypes) => x2(DocsContext).resolveOf(moduleExportOrType, validTypes);
...
var ArgTypes = (props) => {
  ...
  if (!(!!subcomponents && Object.keys(subcomponents || {}).length > 0)) return Rn.createElement(ArgsTable, { rows: filteredArgTypes, sort });
  ...
  return Rn.createElement(TabbedArgsTable, { tabs, sort });
};
...
var require_get_proto = __commonJS2({ "node_modules/.pnpm/get-proto@1.0.1/node_modules/get-proto/index.js"(exports, module) {
  ...
  module.exports = reflectGetProto ? function(O22) {
    return reflectGetProto(O22);
  } : originalGetProto ? function(O22) {
    if (!O22 || typeof O22 != "object" && typeof O22 != "function") throw new TypeError("getProto: not an object");
    return originalGetProto(O22);
  } : getDunderProto ? function(O22) {
    return getDunderProto(O22);
  } : null;
} });
...
var SourceContainer = ({ children, channel }) => {
  ...
  }, []), Rn.createElement(SourceContext.Provider, { value: { sources } }, children);
};
function useTransformCode(source, transform, storyContext) {
  let [transformedCode, setTransformedCode] = d("Transforming..."), transformed = transform ? transform?.(source, storyContext) : source;
  return y(() => {
...
var Source2 = (props) => {
  let sourceContext = x2(SourceContext), docsContext = x2(DocsContext), sourceProps = useSourceProps(props, docsContext, sourceContext);
  return Rn.createElement(Source, { ...sourceProps });
};
...
var Story2 = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = x2(DocsContext), storyId = getStoryId2(props, context), story = useStory(storyId, context);
  if (!story) return Rn.createElement(StorySkeleton, null);
  let storyProps = getStoryProps(props, story, context);
  return storyProps ? Rn.createElement(Story, { ...storyProps }) : null;
};
var Canvas = (props) => {
  let docsContext = x2(DocsContext), sourceContext = x2(SourceContext), { of, source } = props;
  if ("of" in props && of === void 0) throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  ...
  return Rn.createElement(Preview, { withSource: sourceState === "none" ? void 0 : sourceProps, isExpanded: sourceState === "shown", withToolbar, additionalActions, className, layout, inline }, Rn.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story }));
};
...
var useArgsIfDefined = (story, context) => {
  let storyContext = story ? context.getStoryContext(story) : { args: {} }, { id: storyId } = story || { id: "none" }, [args, setArgs] = d(storyContext.args);
  y(() => {
  ...
  let updateArgs = q((updatedArgs) => context.channel.emit(import_core_events.UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId, context.channel]), resetArgs = q((argNames) => context.channel.emit(import_core_events.RESET_STORY_ARGS, { storyId, argNames }), [storyId, context.channel]);
  return story && [args, updateArgs, resetArgs];
};
var useGlobals = (story, context) => {
  let storyContext = context.getStoryContext(story), [globals, setGlobals] = d(storyContext.globals);
  return y(() => {
...
var Controls3 = (props) => {
  ...
  return Rn.createElement(TabbedArgsTable, { tabs, sort, args, globals, updateArgs, resetArgs });
};
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = Rn.useContext(DocsContext);
  return Rn.createElement(DocsContext.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g))) return Rn.createElement(ii, null, children);
  let language = className && className.split("-");
  return Rn.createElement(Source, { language: language && language[1] || "text", format: false, code: children, ...rest });
};
...
var AnchorInPage = ({ hash, children }) => {
  let context = x2(DocsContext);
  return Rn.createElement(A22, { href: hash, target: "_self", onClick: (event) => {
    let id = hash.substring(1);
    document2.getElementById(id) && navigate(context, hash);
  } }, children);
};
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = x2(DocsContext);
  return !href || target === "_blank" || /^https?:\/\//.test(href) ? Rn.createElement(A22, { ...props }) : href.startsWith("#") ? Rn.createElement(AnchorInPage, { hash: href }, children) : Rn.createElement(A22, { href, onClick: (event) => {
...
var HeaderWithOcticonAnchor = ({ as, id, children, ...rest }) => {
  let context = x2(DocsContext), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
  return Rn.createElement(OcticonHeader, { id, ...rest }, Rn.createElement(OcticonAnchor, { "aria-hidden": "true", href: hash, tabIndex: -1, target: "_self", onClick: (event) => {
    document2.getElementById(id) && navigate(context, hash);
  } }, Rn.createElement(LinkIcon, null)), children);
};
var HeaderMdx = (props) => {
  let { as, id, children, ...rest } = props;
  if (id) return Rn.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return Rn.createElement(Component4, { ...J(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({ ...acc, [headerType]: (props) => Rn.createElement(HeaderMdx, { as: headerType, ...props }) }), {});
var Markdown = (props) => {
  ...
  if (typeof props.children != "string") throw new Error(dedent`The Markdown block only accepts children as a single string, but children were of type: '${typeof props.children}'
      ...
      `);
  return Rn.createElement(index_modern_default, { ...props, options: { forceBlock: true, overrides: { code: CodeOrSourceMdx, a: AnchorMdx, ...HeadersMdx, ...props?.options?.overrides }, ...props?.options } });
};
...
var DescriptionContainer = (props) => {
  ...
  return markdown ? Rn.createElement(Markdown, null, markdown) : null;
};
...
var DocsContainer = ({ context, theme, children }) => {
  ...
  }), Rn.createElement(DocsContext.Provider, { value: context }, Rn.createElement(SourceContainer, { channel: context.channel }, Rn.createElement(Tt, { theme: pf(theme) }, Rn.createElement(DocsPageWrapper, { toc: toc ? Rn.createElement(TableOfContents, { className: "sbdocs sbdocs-toc--custom", channel: context.channel, ...toc }) : null }, children))));
};
...
var Heading2 = ({ children, disableAnchor, ...props }) => {
  if (disableAnchor || typeof children != "string") return Rn.createElement(ui, null, children);
  let tagID = slugs.slug(children.toLowerCase());
  return Rn.createElement(HeaderMdx, { as: "h2", id: tagID, ...props }, children);
};
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string") return Rn.createElement(fi, null, children);
  let tagID = slugs.slug(children.toLowerCase());
  return Rn.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
var DocsStory = ({ of, expanded = true, withToolbar: withToolbarProp = false, __forceInitialArgs = false, __primary = false }) => {
  ...
  return Rn.createElement(Anchor, { storyId: story.id }, expanded && Rn.createElement(Rn.Fragment, null, Rn.createElement(Subheading, null, story.name), Rn.createElement(DescriptionContainer, { of })), Rn.createElement(Canvas, { of, withToolbar, story: { __forceInitialArgs, __primary }, source: { __forceInitialArgs } }));
};
var Primary = (props) => {
  let { of } = props;
  if ("of" in props && of === void 0) throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let { csfFile } = useOf(of || "meta", ["meta"]), primaryStory = x2(DocsContext).componentStoriesFromCSFFile(csfFile)[0];
  return primaryStory ? Rn.createElement(DocsStory, { of: primaryStory.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
...
var Stories = ({ title = "Stories", includePrimary = true }) => {
  let { componentStories, projectAnnotations, getStoryContext } = x2(DocsContext), stories = componentStories(), { stories: { filter } = { filter: void 0 } } = projectAnnotations.parameters?.docs || {};
  return filter && (stories = stories.filter((story) => filter(story, getStoryContext(story)))), stories.some((story) => story.tags?.includes("autodocs")) && (stories = stories.filter((story) => story.tags?.includes("autodocs") && !story.usesMount)), includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : Rn.createElement(Rn.Fragment, null, typeof title == "string" ? Rn.createElement(StyledHeading, null, title) : title, stories.map((story) => story && Rn.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })));
};
...
var Subtitle2 = (props) => {
  ...
  return content ? Rn.createElement(Subtitle, { className: "sbdocs-subtitle sb-unstyled" }, content) : null;
};
...
var Title3 = (props) => {
  ...
  return content ? Rn.createElement(Title, { className: "sbdocs-title sb-unstyled" }, content) : null;
};
var DocsPage = () => {
  let resolvedOf = useOf("meta", ["meta"]), { stories } = resolvedOf.csfFile, isSingleStory = Object.keys(stories).length === 1;
  return Rn.createElement(Rn.Fragment, null, Rn.createElement(Title3, null), Rn.createElement(Subtitle2, null), Rn.createElement(DescriptionContainer, { of: "meta" }), isSingleStory ? Rn.createElement(DescriptionContainer, { of: "story" }) : null, Rn.createElement(Primary, null), Rn.createElement(Controls3, null), isSingleStory ? null : Rn.createElement(Stories, null));
};
function Docs({ context, docsParameter }) {
  let Container2 = docsParameter.container || DocsContainer, Page = docsParameter.page || DocsPage;
  return Rn.createElement(Container2, { context, theme: docsParameter.theme }, Rn.createElement(Page, null));
}
...
function ExternalDocs({ projectAnnotationsList, children }) {
  ...
  return Rn.createElement(Docs, { docsParameter, context: preview2.docsContext() });
}
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), Rn.createElement(DocsContext.Provider, { value: preview.docsContext() }, Rn.createElement(Tt, { theme: pf(Me.light) }, children)));
var Meta = ({ of }) => {
  let context = x2(DocsContext);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return Rn.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var Unstyled = (props) => Rn.createElement("div", { ...props, className: "sb-unstyled" });
var Wrapper10 = ({ children }) => Rn.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
var PRIMARY_STORY = "^";
...
//# sourceMappingURL=chunk-V4AKEYZI.js.map
