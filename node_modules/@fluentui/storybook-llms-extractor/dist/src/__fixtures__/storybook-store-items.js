...
Object.defineProperty(exports, "storybookStoreItems", {
    enumerable: true,
    get: function() {
        return storybookStoreItems;
    }
});
const storybookStoreItems = [
    // MDX story
    {
        meta: {
    ...
    // Component story
    {
        meta: {
            ...
            parameters: {
                ...
                docs: {
                    description: {
                        component: 'An accordion allows users to toggle the display of content by expanding or collapsing sections.\n'
                    }
                }
            },
            component: {
                ...
                __docgenInfo: {
                    props: {
                        ...
                        navigation: {
                            defaultValue: null,
                            description: '@deprecated Arrow keyboard navigation is not recommended for accordions. Consider using Tree if arrow navigation is a hard requirement.\nIndicates if keyboard navigation is available and gives two options, linear or circular navigation.',
                            name: 'navigation',
                            required: false,
                            type: {
                                name: 'enum',
            ...
            subcomponents: {
                AccordionItem: {
                    ...
                    __docgenInfo: {
                        description: 'Define a styled AccordionItem, using the `useAccordionItem_unstable` and `useAccordionItemStyles_unstable` hooks.',
                        displayName: 'AccordionItem',
                        props: {
                            as: {
                                defaultValue: null,
                ...
                AccordionHeader: {
                    ...
                    __docgenInfo: {
                        description: 'Define a styled AccordionHeader, using the `useAccordionHeader_unstable` and `useAccordionHeaderStyles_unstable`\nhooks.',
                        displayName: 'AccordionHeader',
                        props: {
                            button: {
                                defaultValue: null,
                ...
                AccordionPanel: {
                    ...
                    __docgenInfo: {
                        description: 'Define a styled AccordionPanel, using the `useAccordionPanel_unstable` and `useAccordionPanelStyles_unstable` hooks.',
                        displayName: 'AccordionPanel',
                        props: {
                            collapseMotion: {
                                defaultValue: null,
        ...
        stories: {
            ...
            'components-accordion--controlled': {
                ...
                parameters: {
                    docs: {
                        description: {
                            story: 'An accordion can be controlled, to ensure `multiple` and `collapsible` you should use `openItems` provided through `onToggle` callback.'
                        }
                    },
            ...
            'components-accordion--heading-levels': {
                ...
                parameters: {
                    docs: {
                        description: {
                            story: 'An accordion header is a `<div>` by default, but according to [WAI-ARIA specification](https://www.w3.org/TR/wai-aria-practices/#wai-aria-roles-states-and-properties), we recommend using a proper heading of any level in markup.'
                        }
                    },
            ...
            'components-accordion--multiple': {
                ...
                parameters: {
                    docs: {
                        description: {
                            story: "An accordion supports multiple panels expanded simultaneously. Since it's not simple to determine which panel will be opened by default, `multiple` will also be collapsed by default on the first render"
                        }
                    },
            ...
            'components-accordion--open-items': {
                ...
                parameters: {
                    docs: {
                        description: {
                            story: 'An accordion can have defined open items. If no open item is present, all panels will be closed by default'
                        }
                    },
...
//# sourceMappingURL=storybook-store-items.js.map